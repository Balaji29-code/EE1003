...
root1_nr = root_finder.newton_raphson(2.5, tolerance, max_iterations)
root2_nr = root_finder.newton_raphson(0, tolerance, max_iterations)

root1_sec = root_finder.secant_method(2.5, 3.5, tolerance, max_iterations)
...
plt.plot(x, y, label='$f(x) = 2x^2 - 7x + 3 $')
